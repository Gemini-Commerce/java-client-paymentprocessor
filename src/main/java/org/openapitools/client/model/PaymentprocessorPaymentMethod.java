...
public class PaymentprocessorPaymentMethod {
   ...
   * @return the PaymentprocessorPaymentMethod instance itself
   */
  public PaymentprocessorPaymentMethod putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.code, paymentprocessorPaymentMethod.code) &&
        ...
        Objects.equals(this.additionalProperties, paymentprocessorPaymentMethod.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(code, title, label, enabled, amount, currency, additionalInfo, isUpfront, description, restrictions, additionalProperties);
  }
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<PaymentprocessorPaymentMethod>() {
           ...
           public PaymentprocessorPaymentMethod read(JsonReader in) throws IOException {
             ...
             PaymentprocessorPaymentMethod instance = thisAdapter.fromJsonTree(jsonObj);
