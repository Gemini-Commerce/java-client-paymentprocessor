...
public class PaymentprocessorAvailabilityContext {
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(shippingAddress, billingAddress, customer);
  }
  ...
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!PaymentprocessorAvailabilityContext.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `PaymentprocessorAvailabilityContext` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
